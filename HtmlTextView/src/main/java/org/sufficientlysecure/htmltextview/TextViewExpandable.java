 ...
 *
 */
class TextViewExpandable extends TextView {
    ...
    /**
     * Expand this {@link TextViewExpandable}.
        ...
        if (!this.expanded && !this.animating && this.collapsedLines >= 0) {
            ...
            valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(final ValueAnimator animation) {
                    final ViewGroup.LayoutParams layoutParams = TextViewExpandable.this.getLayoutParams();
                    layoutParams.height = (int) animation.getAnimatedValue();
                    TextViewExpandable.this.setLayoutParams(layoutParams);
                }
            });
            ...
            valueAnimator.addListener(new AnimatorListenerAdapter() {
                ...
                public void onAnimationEnd(final Animator animation) {
                    ...
                    TextViewExpandable.this.animating = false;
                }
            });
        ...
        if (this.expanded && !this.animating && this.collapsedLines >= 0) {
            ...
            valueAnimator.addListener(new AnimatorListenerAdapter() {
                ...
                public void onAnimationEnd(final Animator animation) {
                    ...
                    TextViewExpandable.this.setMaxLines(TextViewExpandable.this.collapsedLines);
